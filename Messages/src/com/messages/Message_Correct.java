...
public class Message_Correct extends JFrame {
    ...
    public Message_Correct(String texto) {
    ...
    //creamos la etiqueta con icono 
        JLabel icono = new JLabel(new ImageIcon(getClass().getResource("/icons/bien.png")));

...
public class Message_Error extends JFrame {
    ...
    public Message_Error(String texto) {
    ...
    //creamos la etiqueta con icono 
        JLabel icono = new JLabel(new ImageIcon(getClass().getResource("/icons/cross.png")));
